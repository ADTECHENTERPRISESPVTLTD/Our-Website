...
export const SOCIAL_LINKS = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/ad-tech-enterprises-pvt-ltd/",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/ad.tech.enterprises.pvt.ltd/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
