      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <motion.div
            ...
            className="rounded-3xl border border-[#2A3648] bg-[#1A2233]/70 backdrop-blur-xl p-10"
          >
            <div className="h-16 w-16 rounded-2xl bg-blue-600/20 flex items-center justify-center">
              <Eye size={34} className="text-[#38BDF8]" />
            </div>

            <h3 className="text-3xl font-bold mt-8 text-white">Our Vision</h3>

            <p className="mt-6 text-[#94A3B8] leading-8">
          ...
          >
            <div className="h-16 w-16 rounded-2xl bg-cyan-500/20 flex items-center justify-center">
              <Target size={34} className="text-[#38BDF8]" />
            </div>

            <h3 className="text-3xl font-bold mt-8 text-white">Our Mission</h3>

            <ul className="mt-6 space-y-4 text-[#94A3B8] leading-7">
