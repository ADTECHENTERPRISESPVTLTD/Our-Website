    ...
    <div className="min-h-screen bg-background text-foreground relative selection:bg-accent/40 selection:text-white">
      ...
      <header className="sticky top-0 z-40 w-full glass border-b border-border/60">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="font-extrabold text-base tracking-wide bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
                AD TECH
              </span>
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-text-secondary">
            ...
            <a href="#careers" className="hover:text-white transition-colors">Careers & Internships</a>
            <a href="#contact" className="hover:text-white transition-colors">Contact</a>
          </nav>

          <a 
            href="#contact" 
            className="hidden sm:inline-flex items-center gap-1.5 px-4.5 py-2 text-xs font-semibold rounded-full bg-btn-primary text-btn-primary-text hover:bg-slate-200 hover:scale-[1.03] transition-all cursor-pointer shadow-md"
          >
            Get In Touch
      ...
      <section id="hero" className="relative pt-24 pb-20 md:pt-32 md:pb-28 max-w-7xl mx-auto px-6 overflow-hidden">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-card-bg/60 text-xs font-medium text-text-secondary animate-fade-in-up">
            <Sparkles className="h-3.5 w-3.5 text-yellow-400" />
            <span>Building Future Tech Talent</span>
          </div>

          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-[1.1] animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-text-secondary max-w-2xl mx-auto font-normal leading-relaxed animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6 animate-fade-in-up">
            <a 
              href="#services" 
              className="w-full sm:w-auto px-8 py-3.5 text-sm font-semibold rounded-xl bg-btn-primary text-btn-primary-text hover:bg-slate-200 transition-colors shadow-lg cursor-pointer text-center"
            >
              Explore Services
            </a>
            <a 
              href="#careers" 
              className="w-full sm:w-auto px-8 py-3.5 text-sm font-semibold rounded-xl border border-border bg-card-bg/50 hover:bg-card-bg text-white transition-colors cursor-pointer text-center"
            >
      ...
      <section id="services" className="py-20 md:py-24 border-t border-border/40 bg-secondary-bg/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">Our Core Services</h2>
            <p className="text-text-secondary">Custom engineering designed to scale and optimize your operations.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="glass-card p-8 rounded-2xl flex flex-col justify-between hover:border-slate-500/50 hover:scale-[1.01] transition-all group duration-300">
              ...
              <div className="pt-6">
                <a href="#contact" className="inline-flex items-center gap-1 text-xs font-semibold text-sky-400 hover:text-sky-300">
            ...
            <div className="glass-card p-8 rounded-2xl flex flex-col justify-between hover:border-slate-500/50 hover:scale-[1.01] transition-all group duration-300">
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-bold">Backend & DB Architecting</h3>
                <p className="text-text-muted text-sm leading-relaxed">
              ...
              <div className="pt-6">
                <a href="#contact" className="inline-flex items-center gap-1 text-xs font-semibold text-indigo-400 hover:text-indigo-300">
                  Request Info <ArrowUpRight className="h-3 w-3" />
                </a>
              </div>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl flex flex-col justify-between hover:border-slate-500/50 hover:scale-[1.01] transition-all group duration-300">
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-bold">AI Integrations & Agents</h3>
                <p className="text-text-muted text-sm leading-relaxed">
              ...
              <div className="pt-6">
                <a href="#contact" className="inline-flex items-center gap-1 text-xs font-semibold text-purple-400 hover:text-purple-300">
                  Request Info <ArrowUpRight className="h-3 w-3" />
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-border bg-card-bg/60 text-xs font-medium text-indigo-400">
              ...
              <ul className="space-y-3.5 text-text-muted text-sm">
              ...
              <div className="pt-2">
                <a 
                  href={`mailto:${EMAIL}`}
                  className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-semibold rounded-lg bg-slate-800 border border-slate-700 hover:bg-slate-700 text-white cursor-pointer"
                >
            ...
            <div className="glass-card p-8 rounded-2xl space-y-6">
              <h3 className="text-lg font-bold border-b border-border/80 pb-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-start border-b border-border/40 pb-4">
                  <div>
                    <h4 className="font-semibold text-sm text-white">AI Lead / Agent Architect</h4>
                    <span className="text-xs text-text-muted">Research & AI Integrations</span>
                  </div>
                ...
                <div className="flex justify-between items-start border-b border-border/40 pb-4">
                  <div>
                    <h4 className="font-semibold text-sm text-white">Frontend Intern (Next.js/TS)</h4>
                    <span className="text-xs text-text-muted">User Interfaces & Custom CSS</span>
                  </div>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="font-semibold text-sm text-white">Backend Engineer Intern</h4>
                    <span className="text-xs text-text-muted">Node.js, Express, APIs</span>
                  </div>
      ...
      <section id="contact" className="py-20 md:py-24 border-t border-border/40 bg-secondary-bg/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">Connect with Us</h2>
              <p className="text-text-secondary text-base leading-relaxed">
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[10px] text-text-muted block">EMAIL HR</span>
                    <a href={`mailto:${EMAIL}`} className="text-sm font-semibold text-white hover:underline">{EMAIL}</a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${PHONE}`} className="text-sm font-semibold text-white hover:underline">{PHONE}</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              <form className="space-y-4">
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full bg-[#0B1120] border border-border text-sm px-3.5 py-2.5 rounded-xl text-slate-100 placeholder-slate-600 focus:outline-none focus:border-slate-500"
                    placeholder="Soham"
                  />
                </div>
                <div>
                ...
                <div>
                  <label className="text-xs text-text-secondary block mb-1">Message / Project Description</label>
                  <textarea 
                    rows={4}
                    className="w-full bg-[#0B1120] border border-border text-sm px-3.5 py-2.5 rounded-xl text-slate-100 placeholder-slate-600 focus:outline-none focus:border-slate-500 resize-none"
                ...
                <button 
                  ...
                  className="w-full bg-btn-primary text-btn-primary-text font-bold text-sm py-3 rounded-xl transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer"
                >
                  Send Message
                </button>
              </form>
      ...
      {/* 6. Footer */}
      <footer className="py-12 border-t border-border/20 text-center text-xs text-text-muted">
        <div className="max-w-7xl mx-auto px-6 space-y-2">
          <p>© 2026 AD Tech Enterprises Pvt. Ltd. All rights reserved.</p>
          <p className="text-[10px] text-slate-600">Building Future Tech Talent • AI Lead Sprint MVP v1.0</p>
        </div>
      </footer>
